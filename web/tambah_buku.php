    ...
    <div class="container mt-4">
        ...
        <form action="tambah_buku.php" method="post">
            ...
            <div class="mb-3">
                ...
                <input id="penulis" class="form-control" type="text" name="penulis" required>
            </div>
            <div class="mb-3">
                <label for="penerbit" class="form-label">Penerbit</label>
                <input id="penerbit" class="form-control" type="text" name="penerbit" required>
            </div>
            <div class="mb-3">
                <label for="tahun_terbit" class="form-label">Tahun Terbit</label>
                <input id="tahun_terbit" class="form-control" type="number" name="tahun_terbit" required>
            </div>
            <div class="mb-3">
                <label for="stok" class="form-label">Stok</label>
                <input id="stok" class="form-control" type="number" name="stok" required>
            </div>
